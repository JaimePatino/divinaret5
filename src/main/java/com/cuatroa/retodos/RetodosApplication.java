...
public class RetodosApplication implements CommandLineRunner {
    ...
    @Autowired
    private HairProductCrudRepository crudRepository;
    @Autowired
...
//                new HairProduct("AP-903", "ACME 1", "CATEGORIA 1", "NOMBRE 1", "Descripción calidad", true, 80000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-006127.jpg"),
//                new HairProduct("AP-904", "ACME 2", "CATEGORIA 2", "NOMBRE 2", "Descripción precio bajos justo", true, 150000, 10, "https://www.avasoluciones.com/uploads/2021/09/910-007.jpg")
//        ));
//
...
//        Map<String, HairProduct> productOrderOne = new HashMap<String, HairProduct>();
//        Map<String, HairProduct> productOrderTwo = new HashMap<String, HairProduct>();
//
